package br.com.msoficinas.api.config;

import br.com.msoficinas.api.entidades.Endereco;
import br.com.msoficinas.api.entidades.Estabelecimento;
import br.com.msoficinas.api.entidades.Usuario;
import br.com.msoficinas.api.enuns.Estado;
...
public class ClienteParaTestes implements CommandLineRunner {
    ...
    public void inserirClienteTest () {
        ...
        Estabelecimento estabelecimento = Estabelecimento.builder()
                ...
                .razaoSocial("GLÊSIO SANTOS da SILVA AUTO TESTE")
                .contatos(Set.of("86998490423"))
                .logo("https://img.freepik.com/premium-vector/image-available-icon-set-default-missing-photo-stock-vector-symbol-black-filled-outlined-style-no-image-found-sign_268104-6708.jpg")
